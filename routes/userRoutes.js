...
import { changePassword, deleteAddress, getAddresses, getProfile, getReferralInfo, joinMembership, leaveMembership, saveAddress, updateAddress, updatePhotoUrl, updatePreferences, updateProfile } from "../controllers/userController.js";
...
router.patch("/photo", requireAuth, upload.single("photo"),  updatePhotoUrl)
