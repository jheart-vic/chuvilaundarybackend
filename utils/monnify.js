...
async function getAuthToken() {
  ...
  const res = await axios.post(`${MONNIFY_BASE_URL}/v1/auth/login`, {}, {
...
export async function initMonnifyPayment({
  ...
  const res = await axios.post(`${MONNIFY_BASE_URL}/v1/merchant/transactions/init-transaction`, payload, {
